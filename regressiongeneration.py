...
for i in range(len(y_values)):
    predictions = -0.15439311*x[i][0]  + 0.24991438*x[i][1] + 0.13180787*x[i][2] -0.01188607*x[i][3]  + 0.48060192*x[i][4] + 0.1513470856294169
    predictions = round(float(predictions))
    #print(predictions)
